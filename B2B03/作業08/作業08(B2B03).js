...
lib.ssMetadata = [
		{name:"作業08_B2B03__atlas_1", frames: [[0,671,623,434],[0,1107,278,280],[807,671,153,408],[625,671,180,465],[807,1081,192,322],[314,1340,231,138],[280,1107,299,231],[0,1389,312,103],[547,1340,54,128],[0,0,1004,669]]}
];
...
(lib.CachedBmp_9 = function() {
	this.initialize(ss["作業08_B2B03__atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.作業08B2B03 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/作業08_B2B03__atlas_1.png?1701094286807", id:"作業08_B2B03__atlas_1"}
	],
	preloads: []
};
